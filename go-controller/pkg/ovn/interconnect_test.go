...
var _ = ginkgo.Describe("OVN Interconnect Operations", func() {
	...
	ginkgo.BeforeEach(func() {
		...
		var err error
		node1Annotator = kube.NewNodeAnnotator(&kube.Kube{kubeFakeClient, fakeClient.EgressIPClient, fakeClient.EgressFirewallClient, nil}, testNode1.Name)
		...
		node2Annotator = kube.NewNodeAnnotator(&kube.Kube{kubeFakeClient, fakeClient.EgressIPClient, fakeClient.EgressFirewallClient, nil}, testNode2.Name)
		...
		node3Annotator = kube.NewNodeAnnotator(&kube.Kube{kubeFakeClient, fakeClient.EgressIPClient, fakeClient.EgressFirewallClient, nil}, testNode3.Name)
	...
	ginkgo.It("OVN Interconnect test", func() {
		app.Action = func(ctx *cli.Context) error {
			...
			clusterManager := cm.NewClusterManager(fakeClient, f, wg,
