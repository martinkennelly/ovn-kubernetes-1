...
`)
	...
	*/
	table.DescribeTable("[non-OVN managed network] Using different methods to disable a node or pod availability for egress", func(egressIPIP1, egressIPIP2 string) {
		// get v4, v6 from eips
...
`)
	...
	ginkgo.It("[non-OVN managed networks] Multiple EgressIP objects and their Egress IP hosted on the same interface", func() {
